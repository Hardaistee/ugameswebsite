        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: 'var(--muted)' }}>
              <li><Link to="/ilanlar" className="hover:underline transition-colors hover:text-[var(--accent)]">Tüm İlanlar</Link></li>
              <li><Link to="/tek-oyunculu" className="hover:underline transition-colors hover:text-[var(--accent)]">Tek Oyunculu Oyunlar</Link></li>
              <li><Link to="/cekilisler" className="hover:underline transition-colors hover:text-[var(--accent)]">Çekilişler</Link></li>
              <li><Link to="/iletisim" className="hover:underline transition-colors hover:text-[var(--accent)]">Yardım Merkezi</Link></li>
              <li><Link to="/iletisim" className="hover:underline transition-colors hover:text-[var(--accent)]">İletişim</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: 'var(--muted)' }}>
              <li><Link to="/hakkimizda" className="hover:underline transition-colors hover:text-[var(--accent)]">Hakkımızda</Link></li>
              <li><Link to="/gizlilik-politikasi" className="hover:underline transition-colors hover:text-[var(--accent)]">Gizlilik Sözleşmesi</Link></li>
              <li><Link to="/mesafeli-satis-sozlesmesi" className="hover:underline transition-colors hover:text-[var(--accent)]">Mesafeli Satış Sözleşmesi</Link></li>
              <li><Link to="/iade-kosullari" className="hover:underline transition-colors hover:text-[var(--accent)]">Teslimat ve İade Şartları</Link></li>
              <li><Link to="/kullanim-kosullari" className="hover:underline transition-colors hover:text-[var(--accent)]">Kullanım Koşulları</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t pt-6" style={{ borderColor: 'var(--border)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs" style={{ color: 'var(--muted)' }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/gizlilik-politikasi" className="hover:underline transition-colors hover:text-[var(--accent)]">Gizlilik</Link>
              <span>•</span>
              <Link to="/kullanim-kosullari" className="hover:underline transition-colors hover:text-[var(--accent)]">Şartlar</Link>
              <span>•</span>
              <Link to="/gizlilik-politikasi" className="hover:underline transition-colors hover:text-[var(--accent)]">Çerezler</Link>
            </div>
          </div>
        </div>
      </div>
