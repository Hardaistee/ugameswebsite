...
export default function GameSearchClient({ allGames }: { allGames: Game[] }) {
    ...
    const games = useMemo(() => {
        let list = allGames.filter((game) => {
            ...
            if (filters.category !== 'all') {
                ...
                // For CSV data, check tags or category if 'bestsellers' logic exists
                // simplified logic for now
                if (filters.category === 'bestsellers' && !game.categories?.includes('Çok Satan')) return false
        ...
        // CSV doesn't have createdAt, so remove newest sort or use ID?
        ...
        <div className="min-h-screen pb-12" style={{ background: 'var(--bg)' }}>
            <div className="max-w-7xl mx-auto px-4 py-6">
                ...
                <div className="flex items-center gap-2 mb-4 text-sm">
                    ...
                    <Link href="/oyun-ara" className="hover:underline" style={{ color: 'var(--muted)' }}>Oyun</Link>
