...
export default function Footer() {
  return (
    <footer role="contentinfo" className="border-t mt-8" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              >
                <svg className="w-4 h-4" style={{ color: 'var(--text)' }} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <div className="mb-4">
              <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg" style={{ background: 'var(--bg)', border: '1px solid var(--border)' }}>
                <svg className="w-5 h-5" style={{ color: '#10b981' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="h-auto w-auto flex items-center justify-center rounded">
                <img src="/images/visa.svg" alt="Visa ödeme yöntemi" width={48} height={48} className="h-12 w-12 object-contain p-1" loading="lazy" />
              </div>
