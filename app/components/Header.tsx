        ...
        <div className="hidden md:block border-b" style={{ borderColor: 'var(--border)', background: 'var(--bg)' }}>
          <div className="max-w-6xl mx-auto px-4 py-1.5">
            <div className="flex items-center justify-between text-xs" style={{ color: 'var(--muted)' }}>
              ...
              {/* Right: Blog + App Download + Social Media */}
              <div className="flex items-center gap-4">
                ...
                <Link
                  href="/indir"
                  className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg font-semibold hover:opacity-80 transition-opacity"
                ...
                <div className="flex items-center gap-3">
                  <a href="https://www.instagram.com/ugamescomtr/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors" aria-label="Instagram">
